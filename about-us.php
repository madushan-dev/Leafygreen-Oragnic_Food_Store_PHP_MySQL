...
<section class="mt-5 ">
    ...
    <div class="vision-mission d-flex justify-content-center pt-5">
        <div>
            <h2>Vision</h2>
            <p>Join with vendors and to establish farming to contribute in a sustainable healthy nation and removing
                poverty though it by creating employment as well as earn small income</p>

        </div>
        <div>
            <h2>Mission</h2>
            <p>Leafy green Market is committed to providing the highest quality, fresh and natural food, health and
                wellness products. Our staff are friendly, eager to serve and ready to educate</p>
...
<section class="mt-5">
    <div class="row">
        <h2 class="category-title" style="font-size:2rem">Team Members </h2>
        <div class="team d-flex justify-content-center">
            <div>
                <img class="img-fluid" src="images/team/madushan.jpg" alt="">
                <div class="team-details">
                    <h3>Madushan Gunarathne</h3>
                    <h4>Co-founder</h4>
                </div>
            </div>
            <div>
            ...
            <div>
                <img class="img-fluid" src="images/team/prabash.jpg" alt="">
                <div class="team-details">
                    <h3>Prabash Jayaweera</h3>
                    <h4>Co-founder</h4>
                </div>
            </div>
            <div>
                <img class="img-fluid" src="images/team/kasuni.jpeg" alt="">
                <div class="team-details">
                    <h3>Kasuni Upeksha</h3>
                    <h4>Co-founder</h4>
                </div>
            </div>
            <div>
            ...
            <div>
                <img class="img-fluid" src="images/team/yohan.jpg" alt="">
                <div class="team-details">
                    <h3>Avishka Yohan</h3>
                    <h4>Co-founder</h4>
                </div>
